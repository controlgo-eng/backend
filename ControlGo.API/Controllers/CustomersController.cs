...
using ControlGo.Application.Features.Customers.Command;
using ControlGo.Application.Features.Customers.DTOs;
using ControlGo.Application.Features.Customers.Queries;


namespace ControlGo.API.Controllers.Customers
{
    /// <summary>
