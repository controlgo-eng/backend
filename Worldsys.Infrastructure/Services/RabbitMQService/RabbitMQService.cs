...
namespace Worldsys.Infrastructure.Services.RabbitMQService
{
    public class RabbitMQService : IMessageQueueService
    {
        ...
        public void EnqueueMessageAsync<T>(string queueName, T message)
        {
        ...
        public void EnqueueMessageAsync(string queueName, string message)
        {
            _channel.QueueDeclare(queue: queueName, durable: false, exclusive: false, autoDelete: false, arguments: null);
        ...
        public Task<string?> DequeueMessageAsync(string queueName)
        {
            _channel.QueueDeclare(queue: queueName, durable: false, exclusive: false, autoDelete: false, arguments: null);
